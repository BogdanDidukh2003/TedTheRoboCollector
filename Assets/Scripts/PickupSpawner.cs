...
public class PickupSpawner : MonoBehaviour
{
    ...
    const int MaxPickupsNumberToSpawn = 50;
    int alreadySpawnedPickupsNumber = 0;
	...
	{
		if (alreadySpawnedPickupsNumber >= MaxPickupsNumberToSpawn)
	    {
		    return;
	    }
